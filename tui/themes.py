...
THEMES: Dict[str, Dict[str, str]] = {
    ...
    "hacker-vibe": {
        ...
        "log.error": "#ff4444",
        "context": "bg:#0a1e1a",
        "context.title": "#00ff88",
        "context.label": "#00a366",
        "context.value": "#00ffaa",
        "input": "bg:#081816 #00ffcc",
        "input.prompt": "#00ff88",
        "menu": "bg:#0a1e1a",
        "menu.title": "#00ff88",
        "menu.item": "#00ffaa",
        "menu.selected": "bg:#00a366 #00ffcc",
        "toggle.on": "#00ff88",
        "toggle.off": "#ff4444",
        "status.menu": "bg:#00e673 #081816",
        "status.chat": "bg:#00a366 #00ffcc",
        "status.processing": "bg:#00ffcc #081816",
        "input.menu": "bg:#00e673 #081816",
        "input.hint": "#008855",
        "agent.atlas": "#00ff88",
        "agent.tetyana": "#00ffcc",
        "agent.grisha": "#00e673",
        "agent.user": "#00a366",
        "agent.system": "#008855",
        "agent.text": "#00ffaa",
        "scrollbar.background": "#0a1e1a",
        "scrollbar.button": "bg:#0d2d2a",
        "scrollbar.arrow": "#0d2d2a",
        "log.tool.success": "#00ff88",
        "log.tool.fail": "#ff4444",
        "log.tool.run": "#00ffcc",
    },
}
