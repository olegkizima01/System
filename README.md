...
- **Автоматично генерується** при кожному коміті.
- Слугує навігатором для розробників та AI (алгоритм, логи, історія).
- Містить актуальний стан точок входу (`cli.sh`, `tui/cli.py`).
