...
echo "  7️⃣  Інструкція з інсталяції Windsurf (чи потрібне перезавантаження?)"
echo "  8️⃣  Управління конфігураціями (профілями) 🆕"
echo "  0️⃣  Вихід"
echo ""
echo -n "Виберіть опцію [0-8]: "
...
case $choice in
    ...
    7)
        echo ""
        echo "📥 Інструкція з інсталяції Windsurf..."
        echo ""
        echo "════════════════════════════════════════════════════════════"
        echo "❓ ЧИ ПОТРІБНЕ ПЕРЕЗАВАНТАЖЕННЯ ПІСЛЯ CLEANUP?"
        echo "════════════════════════════════════════════════════════════"
        echo ""
        echo "🎯 КОРОТКА ВІДПОВІДЬ: НІ!"
        echo ""
        echo "✅ Windsurf можна запускати ОДРАЗУ після cleanup"
        echo "✅ Перезавантаження НЕ потрібне"
        echo "✅ Всі зміни діють негайно"
        echo ""
        echo "❌ Перезавантаження навіть ШКІДЛИВЕ:"
        echo "   • Видалить бекапи з /tmp"
        echo "   • Зупинить автовідновлення"
        echo ""
        echo "════════════════════════════════════════════════════════════"
        echo ""
        echo "📖 Повна інструкція:"
        echo ""
        
        if command -v bat &> /dev/null; then
            bat INSTALLATION_GUIDE.md
        elif command -v less &> /dev/null; then
    ...
    8)
        echo ""
        echo "🔧 Запуск менеджера конфігурацій..."
        echo ""
        ./manage_configs.sh
        ;;
