...
cat > "$SCRIPT_DIR/behavior_randomizer.sh" << 'EOF'
#!/bin/zsh
...
chmod +x "$SCRIPT_DIR/behavior_randomizer.sh"
...
<dict>
    ...
    <array>
        <string>$SCRIPT_DIR/behavior_randomizer.sh</string>
    </array>
    <key>RunAtLoad</key>
    <true/>
</dict>
...
"$SCRIPT_DIR/deep_windsurf_cleanup.sh" >/dev/null 2>&1
