...
- NO ACKNOWLEDGMENT: Заборонено просто "погоджуватись" або "розуміти стратегію". Ти МАЄШ викликати інструмент. Якщо в описі кроку немає прямої команди на інструмент — вибери найбільш логічний (напр. `capture_screen` або `browser_snapshot`).
